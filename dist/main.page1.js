...
/* harmony import */ var jquery_dist_jquery_slim_min_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(902);
/* harmony import */ var jquery_dist_jquery_slim_min_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(jquery_dist_jquery_slim_min_js__WEBPACK_IMPORTED_MODULE_1__);
...
(jquery_dist_jquery_slim_min_js__WEBPACK_IMPORTED_MODULE_1___default().fn.exists) = function () {
...
window.addEventListener("load", () => {
	...
	if (name) {
		...
		setTimeout(apiSearchRequest.bind(undefined, "name", "japan"), 100);
	}
});
...
function fixPagination() {
	...
	if (vw < 380 && pagesDiv.children.length > 7) {
		...
		const pageBtnsArray = jquery_dist_jquery_slim_min_js__WEBPACK_IMPORTED_MODULE_1___default()(".btns-page button");
...
async function importSearchParams(opt) {
	const Arr = await __webpack_require__(959)(`./${opt}.js`);
